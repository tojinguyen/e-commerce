...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_delivery_http.BatchGetRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/products/search": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search query (omit for a pure range search)",
                        "name": "q",
                        "in": "query"
                    },
                    {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_delivery_http.AdjustStockRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_delivery_http.AdjustStockRequest": {
            "type": "object",
            "properties": {
                "delta": {
                    "type": "integer"
        ...
        "internal_delivery_http.BatchGetRequest": {
            "type": "object",
            "properties": {
                "ids": {
                    "type": "array",
